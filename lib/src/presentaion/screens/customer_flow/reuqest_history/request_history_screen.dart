                  ...
                  children: [
                    ...
                    ListView(
                      ...
                      children: [
                              ...
                              child: GestureDetector(
                                ...
                                child: SizedBox(
                                  ...
                                  child: OnGoingRequestCard(
                                    ...
                                    servicesList: const [],
                                    variant:
                                        OngoingRequestCardVariant.offerReceived,
                                    onTap: () => SheetComponenet.show(
                                      context,
                                      isScrollControlled: true,
                                      child: const RequestSheet(),
                        ...
                        12.verticalSpace,
                        state.newRequestWorkOrders.isNotEmpty ?  ListView.separated(
                          shrinkWrap: true,
                    ...
                    //
                    //
                    state.completedOrders.isNotEmpty ? ListView.separated(
                      shrinkWrap: true,
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        RequestEntity currentRequest = state.completedOrders[index];
                    ...
                    //
                    //
                    state.cancelledOrders.isNotEmpty ? ListView.separated(
                      shrinkWrap: true,
                      ...
                      separatorBuilder: (context, index) => 12.verticalSpace,
                      itemBuilder: (BuildContext context, int index) {
                        RequestEntity currentRequest = state.cancelledOrders[index];
