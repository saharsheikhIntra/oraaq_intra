...
class _QuestionsAccordionState extends State<QuestionsAccordion> {
  ...
  Widget _buildList(ServiceEntity service) {
    // Recursive rendering: Check if the service has sub-services
    if (service.services.isNotEmpty && !service.isLastLeaf) {
      return QuestionsAccordion(
        service: service,
        onChanged: (selected) {
      ...
      // Last node: Render as a SingleQuestionTile
      return SingleQuestionTile(
        title: service.shortTitle,
        subtitle: "Rs. ${service.price}",
            ...
            Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return _buildList(_options[index]);
                },
              ),
            ),
          ],
