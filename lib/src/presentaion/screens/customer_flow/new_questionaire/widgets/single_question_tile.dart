...
class SingleQuestionTile2 extends StatefulWidget {
  final String title;
  final String subtitle;
  final Function(bool) onChanged;

  const SingleQuestionTile2({
    super.key,
    required this.title,
  ...
  @override
  State<SingleQuestionTile2> createState() => _SingleQuestionTile2State();
}

class _SingleQuestionTile2State extends State<SingleQuestionTile2> {
